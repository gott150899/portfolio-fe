...
export const projects: Project[] = [
  {
    ...
    tech: ["Angular", "NgPrime", "Tailwindv4", "Rxjs", "Ngrx Component Store", "FormBuilder", "Litepicker"],
    features: [
  ...
  },
  {
    ...
    tech: ["Angular", "TaigaUI", "Tailwindcss", "Rxjs", "Ngrx", "SSR", "Prerender", "FormBuilder"],
    features: [
  ...
  },
  {
    ...
    tech: ["Angular", "Antd", "Tailwindcss", "Rxjs", "Ngrx", "SSR"],
    features: [
  ...
  },
  {
    ...
    tech: ["Angular", "SCSS", "Ngx Boostrap", "SSR", "Rxjs"],
    features: [
...
export const sideProjects: Project[] = [
  ...
  },
  {
    ...
    tech: ["Angular", "Antd", "Taiwindcss", "Rxjs", "Ngrx", "FormBuilder"],
    features: [
